...
public class BinarySearchIntArray implements Cloneable {
	...
	/**
	 * Creates a new BinarySearchIntArray containing no keys that will not require any additional memory allocation to store the
	...
	/**
	 * Adds a specified key , replacing the previous specified key if there was one.
	 */
