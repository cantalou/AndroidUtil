...
public class ReflectUtil
{
     ...
     * @param targetClassName 对象类名称
     * @return 返回属性值
     */
    public static <T> T get(String targetClassName, String fieldName)
    {
        Object target = forName(targetClassName);
        if (target != null)
        {
